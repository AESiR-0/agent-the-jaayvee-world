    ...
    return (
      <div className="bg-white rounded-xl border border-border shadow-soft p-6">
        ...
        <div className="text-center py-4">
          ...
          <p className="text-sm text-foreground/70 mt-2">Loading updates...</p>
        </div>
      </div>
    );
  }
  ...
  if (updates.length === 0) {
    return (
      <div className="bg-white rounded-xl border border-border shadow-soft p-6">
        ...
        <div className="text-center py-4">
          <p className="text-sm text-foreground/70">No updates at this time.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-4 max-h-96 overflow-y-auto">
        {updates.map((update) => (
          ...
          >
            ...
            <p className="text-sm text-foreground/80 whitespace-pre-wrap mb-2">
              {update.message}
            </p>
